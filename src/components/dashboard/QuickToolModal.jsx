...
import { FiX, FiPlus, FiTrash2, FiCheck, FiCheckSquare, FiSquare, FiSave } from 'react-icons/fi';
...
const QuickToolModal = ({ isOpen, onClose, tool }) => {
    ...
    const [items, setItems] = useState([]); // For Lists (Bucket, Todo)
                ...
                >
                    ...
                    <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-gray-50/50 dark:bg-gray-800/50">
                        <h2 className="text-xl font-bold text-gray-800 dark:text-white flex items-center gap-2">
                           {type === 'bucket-list-2026' ? '🌍 ' : type === 'todo-list' ? '📝 ' : '📅 '}
                           {title}
                        </h2>
                        <button 
                            onClick={onClose}
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-4">
                                <div className="flex gap-2 mb-6">
                                    <input 
                                        ...
                                        className="flex-1 px-4 py-3 bg-gray-50 dark:bg-gray-800 rounded-xl border-none ring-1 ring-gray-200 dark:ring-gray-700 focus:ring-2 focus:ring-indigo-500 outline-none transition-all"
                                    />
                                    <button 
                                        onClick={addItem}
                                ...
                                <div className="space-y-2">
                                    ...
                                    {items.map(item => (
                                        ...
                                        >
                                            ...
                                            <span className={`flex-1 text-base ${item.completed ? 'line-through text-gray-400' : 'text-gray-800 dark:text-gray-200'}`}>
                                                {item.text}
                                            </span>
                                            <button 
                            ...
                            <div className="h-full flex flex-col">
                                ...
                                <textarea
                                    ...
                                    className="flex-1 w-full p-4 bg-yellow-50 dark:bg-yellow-900/10 rounded-xl resize-none border-none ring-1 ring-yellow-100 dark:ring-yellow-800/30 focus:ring-2 focus:ring-amber-400 outline-none text-lg leading-relaxed text-gray-800 dark:text-gray-100 font-serif"
